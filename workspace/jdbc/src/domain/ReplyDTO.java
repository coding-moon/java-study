...
public class ReplyDTO {
   ...
   public ReplyDTO() {;}
	...
	public String toString() {
		return "ReplyDTO [userId=" + userId + ", userIdentification=" + userIdentification + ", userName=" + userName
				...
				+ boardRegisterDate + ", boardUpdateDate=" + boardUpdateDate + ", replyId=" + replyId
				+ ", replyContent=" + replyContent + ", replyRegisterDate=" + replyRegisterDate + ", replyUpdateDate="
				+ replyUpdateDate + ", replyGroup=" + replyGroup + ", replyDepth=" + replyDepth + "]";
	}
