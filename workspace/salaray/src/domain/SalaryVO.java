...
public class SalaryVO {
   ...
   public String toString() {
      return "SalaryVO [salary=" + salary + ", netPay=" + netPay + ", taxDeductionAmount=" + taxDeductionAmount
            + ", pension=" + pension + ", healthInsurance=" + healthInsurance + ", longTermCarePay="
            + longTermCarePay + ", employmentInsurance=" + employmentInsurance + ", incomeTax=" + incomeTax
            + ", localTax=" + localTax + "]";
   }
}